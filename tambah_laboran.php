                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required id="nip"
                                    placeholder="Masukan NIP Laboran" autocomplete="off" name="nip">
                            </div>
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="text" class="form-control" required id="username"
                                    placeholder="Masukan Username Laboran" autocomplete="off" name="username" value="">
                            </div>

                            <div class="form-group">
                                <label for="password">Password</label>
                                <input type="password" class="form-control" required id="password"
                                    placeholder="Masukan Password Laboran" autocomplete="off" name="password" value="">
                            </div>

                            <div class="form-group">
                                <label for="nama">Nama</label>
                                <input type="text" class="form-control" required id="nama"
                                    placeholder="Masukan Nama Laboran" autocomplete="off" name="nama" value="">
                            </div>
