...
function tambah($data)
{
    ...
    // query insert data
    $query = "INSERT INTO kepala_laboran VALUES
...
function delete($id_kepala_laboran)
{
    global $link;

    $hapus = "DELETE FROM kepala_laboran WHERE id_kepala_laboran = $id_kepala_laboran";
...
function update($data)
{
    ...
    // $id_laboran
    $id_kepala_laboran = $data["id_kepala_laboran"];
    $nip = htmlspecialchars($data["nip"]);
    $username = htmlspecialchars($data["username"]);
    $password = htmlspecialchars($data["password"]);
    $nama = htmlspecialchars($data["nama"]);
    ...
    $query = "UPDATE kepala_laboran SET 
                username = '$username',
                password = '$password',
                nama = '$nama',
                jabatan = '$jabatan',
                nip = '$nip'
                WHERE id_kepala_laboran = $id_kepala_laboran
                ";
    mysqli_query($link, $query);
    return mysqli_affected_rows($link);
}
