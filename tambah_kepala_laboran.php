        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 mt-5 mb-3">Data Kepala Laboran</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4 p-4 col-12 col-lg-8">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="nip">NIP</label>
                                <input type="text" class="form-control" required id="nip"
                                    placeholder="Masukan NIP Kepala Laboran" autocomplete="off" name="nip">
                            </div>
                            <div class="form-group">
                                <label for="username">Username</label>
                                <input type="text" class="form-control" required id="username"
                                    placeholder="Masukan Username Kepala Laboran" autocomplete="off" name="username"
                                    value="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" required id="password"
                                    placeholder="Masukan Password Kepala Laboran" autocomplete="off" name="password"
                                    value="">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required id="nama"
                                    placeholder="Masukan Nama Kepala Laboran" autocomplete="off" name="nama" value="">
                            </div>

                            <div class="form-group">
                                <label for="jabatan">Jabatan</label>
                                <input type="text" class="form-control" required id="nama" placeholder="Masukan jabatan"
                                    autocomplete="off" name="jabatan" value="">
                            </div>
