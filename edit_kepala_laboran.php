...
$kepala_laboran = query("SELECT * FROM kepala_laboran WHERE id_kepala_laboran = $id_kepala_laboran")[0];
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 mt-5 mb-3">Anggota kepala_Laboran</h1>
                    <!-- DataTales Example -->
                    <div class="card shadow mb-4 p-4 col-12 col-lg-8">
                        <form method="post" enctype="multipart/form-data">

                            <div class="form-group">
                                <input type="hidden" id="id_kepala_laboran" name="id_kepala_laboran"
                                    value="<?= $kepala_laboran["id_kepala_laboran"]; ?>">
                            </div>

                            <div class="form-group">
                                <label for="nip">NIP</label>
                                <input type="text" class="form-control" id="nip" placeholder="Masukan NIP Laboran"
                                    required autocomplete="off" name="nip" value="<?= $kepala_laboran["nip"]; ?>">
                            </div>
